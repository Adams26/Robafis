...
void setup() {
  ...
  avancerAvecCorrection(dernierCapCible, 4);
 ...
 // Avancer en ligne droite au cap 0° (passe de A5 à B5)
  ...
  avancerAvecCorrection(dernierCapCible, 5);
  ...
  avancerEnMarcheArriere(dernierCapCible, 4);
  tourneAGauche();
  ...
  //recule vers C3
  //avancerEnMarcheArriere(dernierCapCible, delay_3cases);
  //tourneAGaucheAxe();
